...
def seed_db():
    ...
    expenses = [
        ...
        (user_id, 60.00,  "Health",        "2026-05-05", "Pharmacy"),
        (user_id, 25.00,  "Entertainment", "2026-05-07", "Movie tickets"),
        (user_id, 89.99,  "Shopping",      "2026-05-10", "New shoes"),
        (user_id, 10.00,  "Other",         "2026-05-12", "Miscellaneous"),
        (user_id, 33.75,  "Food",          "2026-05-15", "Restaurant dinner"),
    ]
    conn.executemany(
